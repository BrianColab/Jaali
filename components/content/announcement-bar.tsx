...
export function AnnouncementBar({ content }: AnnouncementBarProps) {
  return (
    <>
        ...
        <Container>
          <Reveal kind="fadeUp" className="announcement-bar__inner">
            <div className="announcement-bar__message">
              <span
                className="announcement-bar__icon-wrap"
                aria-hidden="true"
              >
                <svg
              ...
              <div className="announcement-bar__copy">
                <p className="announcement-bar__meta">
                  ...
                  <span className="announcement-bar__format">
                    Official PDF
                  </span>
                </p>
                <p className="announcement-bar__headline">
                  {content.headline}
                </p>
              </div>
            </div>
      ...
      <div className="announcement-bar__quarters" aria-hidden="true" />
    </>
  );
}
